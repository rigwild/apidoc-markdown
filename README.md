...
`apidoc-markdown` uses data generated by [apiDoc](https://github.com/apidoc/apidoc). To generate your nice Markdown documentation, you need to add some [apiDoc](https://github.com/apidoc/apidoc) API documentation comments in your code first. Take a look at https://apidocjs.com/ if it's your first time using it! 😉
