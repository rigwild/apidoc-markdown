// Example from https://github.com/apidoc/apidoc/tree/master/example
 ...
 */
  ...
  * @apiQuery {Number} [id=123] Category ID.
  * @apiQuery {Number} id2 Category ID2.
  */
